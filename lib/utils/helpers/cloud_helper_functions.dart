...
/// Helper functions for Cloud / Database record state handling
class TCloudHelperFunctions {
  ...
  /// If data is still loading, it returns a [CircularProgressIndicator] or [loader].
  /// If no data is found, it returns a generic "No Data Found" message or [nothingFound].
  /// If an error occurs, it returns a generic error message or [error].
